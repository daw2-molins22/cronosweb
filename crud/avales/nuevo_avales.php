...
<head>
    ...
    <title>Nuevo Aval</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
</head>
<body>

    <div class="container mt-5" style="text-align: center;">
        <h1>Nuevo Registro De Aval</h1>

        <form action="insert_avales.php" method="post">

            <div class="row p-1">
                <div class="col-md-12">
                    <h6 class="font-weight-semibold"><i class=""></i> Codigo</h6>
                    <input type="text" class="form-control" name="aval_codigo" id="aval_codigo">
                </div>
            </div>
            ...
            <div class="row p-1">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" name="aval_descripcion" id="aval_descripcion">
                </div>
            </div>
