                    ...
                    <div id="user_area">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h5 class="card-title">Areas De Negocio Registradas</h5>
                                <!--<button type="button" class="btn bg-orange" id="button_nuevo_usuario"><i class="icon-floppy-disk "></i> Nuevo</button>-->
                                <a href="../crud/areas_de_negocio/nuevo_areas_de_negocio.php">
                                    <button type="button" class="btn bg-orange" id="button_nuevo_usuario"><i class="icon-floppy-disk "></i> Nuevo</button>
                                </a>
                                                ...
                                                <table id="datatable_lista" style="font-size: .8125rem;" class="table table-hover dataTable no-footer dtr-column" role="grid">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo '<tr>';
                                                            ...
                                                            $sql = "SELECT Areas_de_Negocio_ID, Areas_de_Negocio, Areas_de_Negocio_Activo
                                                            FROM Areas_de_Negocio";
                                                            ...
                                                            while($row=sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                                                echo '<tr>';
                                                                echo '<td>'.$row['Areas_de_Negocio_ID'].'</td>';
                                                                echo '<td>'.$row['Areas_de_Negocio'].'</td>';
                                                                echo '<td>'.$row['Areas_de_Negocio_Activo'].'</td>';
                                                                ?>

                                                                <td><a href="../crud/areas_de_negocio/actualizar_areas_de_negocio.php?id=<?php echo $row['Areas_de_Negocio_ID'] ?>" class="btn btn-info">Editar</a></td>
                                                                <td><a href="../crud/areas_de_negocio/delete_areas_de_negocio.php?id=<?php echo $row['Areas_de_Negocio_ID'] ?>" class="btn btn-danger">Eliminar</a></td>
