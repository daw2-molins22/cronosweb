                                                ...
                                                <table id="datatable_lista" style="font-size: .8125rem;" class="table table-hover dataTable no-footer dtr-column" role="grid">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo '<tr>';
                                                            ...
                                                            $sql = "SELECT Aval_ID, Aval_Codigo, Aval_Descripción
                                                            FROM Avales";
                                                            ...
                                                            while($row=sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                                                echo '<tr>';
                                                                echo '<td>'.$row['Aval_ID'].'</td>';
                                                                echo '<td>'.$row['Aval_Codigo'].'</td>';
                                                                echo '<td>'.$row['Aval_Descripción'].'</td>';
                                                                ?>

                                                                <td><a href="../crud/avales/actualizar_avales.php?id=<?php echo $row['Aval_ID'] ?>" class="btn btn-info">Editar</a></td>
                                                                <td><a href="../crud/avales/delete_avales.php?id=<?php echo $row['Aval_ID'] ?>" class="btn btn-danger">Eliminar</a></td>
