                    ...
                    <div id="user_area">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                ...
                                <a href="../crud/empresas/nuevo_empresas.php">
                                    <button type="button" class="btn bg-orange" id="button_nuevo_usuario"><i class="icon-floppy-disk "></i> Nuevo</button>
                                </a>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo '<tr>';
                                                            ...
                                                            while($row=sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                                                ...
                                                                <td><a href="../crud/empresas/actualizar_empresas.php?id=<?php echo $row['Empresa_ID'] ?>" class="btn btn-info">Editar</a></td>
                                                                <td><a href="../crud/empresas/delete_empresas.php?id=<?php echo $row['Empresa_ID'] ?>" class="btn btn-danger">Eliminar</a></td>
