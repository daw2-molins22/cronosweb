                                                ...
                                                <table id="datatable_lista" style="font-size: .8125rem;" class="table table-hover dataTable no-footer dtr-column" role="grid">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo '<tr>';
                                                            ...
                                                            $sql = "SELECT Provincias_ID, Provincia
                                                            FROM Provincias";
                                                            ...
                                                            while($row=sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                                                echo '<tr>';
                                                                echo '<td>'.$row['Provincias_ID'].'</td>';
                                                                echo '<td>'.$row['Provincia'].'</td>';
                                                                ?>

                                                                <td><a href="../crud/provincias/actualizar_provincias.php?id=<?php echo $row['Provincias_ID'] ?>" class="btn btn-info">Editar</a></td>
                                                                <td><a href="../crud/provincias/delete_provincias.php?id=<?php echo $row['Provincias_ID'] ?>" class="btn btn-danger">Eliminar</a></td>
