                    ...
                    <div id="user_area">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                ...
                                <a href="../ajax/roles/nuevo_roles.php">
                                    <button type="button" class="btn bg-orange" id="button_nuevo_usuario"><i class="icon-floppy-disk "></i> Nuevo</button>
                                </a>
                                                ...
                                                <table id="datatable_lista" style="font-size: .8125rem;" class="table table-hover dataTable no-footer dtr-column" role="grid">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo '<tr>';
                                                            ...
                                                            $sql = "SELECT Roles_ID, Roles_Descripcion, Roles_Activo
                                                            FROM Roles";
                                                            ...
                                                            while($row=sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                                                ...
                                                                echo '<td>'.$row['Roles_Descripcion'].'</td>';
                                                                echo '<td>'.$row['Roles_Activo'].'</td>';
                                                                ?>

                                                                <td><a href="../crud/roles/actualizar_roles.php?id=<?php echo $row['Roles_ID'] ?>" class="btn btn-info">Editar</a></td>
                                                                <td><a href="../crud/roles/delete_roles.php?id=<?php echo $row['Roles_ID'] ?>" class="btn btn-danger">Eliminar</a></td>
