                    ...
                    <div id="user_area">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h5 class="card-title">Tipo De Clientes Registrados</h5>
                                <!--<button type="button" class="btn bg-orange" id="button_nuevo_usuario"><i class="icon-floppy-disk "></i> Nuevo</button>-->
                                <a href="../crud/tipos_clientes/nuevo_tipos_clientes.php">
                                    <button type="button" class="btn bg-orange" id="button_nuevo_usuario"><i class="icon-floppy-disk "></i> Nuevo</button>
                                </a>
                                                ...
                                                <table id="datatable_lista" style="font-size: .8125rem;" class="table table-hover dataTable no-footer dtr-column" role="grid">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo '<tr>';
                                                            ...
                                                            $sql = "SELECT Tipos_clientes_ID, Tipos_clientes
                                                            FROM Tipos_clientes";
                                                            ...
                                                            while($row=sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                                                ...
                                                                echo '<td>'.$row['Tipos_clientes'].'</td>';
                                                                ?>

                                                                <td><a href="../crud/tipos_clientes/actualizar_tipos_clientes.php?id=<?php echo $row['Tipos_clientes_ID'] ?>" class="btn btn-info">Editar</a></td>
                                                                <td><a href="../crud/tipos_clientes/delete_tipos_clientes.php?id=<?php echo $row['Tipos_clientes_ID'] ?>" class="btn btn-danger">Eliminar</a></td>
