                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo '<tr>';
                                                            ...
                                                            while($row=sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                                                ...
                                                                <td><a href="../crud/usuarios/actualizar_usuario.php?id=<?php echo $row['Usuarios_ID'] ?>" class="btn btn-info">Editar</a></td>
                                                                <td><a href="../crud/usuarios/delete_usuario.php?id=<?php echo $row['Usuarios_ID'] ?>" class="btn btn-danger">Eliminar</a></td>
